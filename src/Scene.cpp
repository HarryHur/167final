...
void Scene::draw(void){
    ...
    while( ! dfs_stack.empty() ){
        ...
        cur_VM = matrix_stack.top();   matrix_stack.pop(); // (HW3 hint: you should do something here)
        ...
        for ( unsigned int i = 0; i < cur -> models.size(); i++ ){
            ...
            shader -> modelview = cur_VM * M; // HW3: Without updating cur_VM, modelview would just be camera's view matrix.
        ...
        for ( unsigned int i = 0; i < cur -> childnodes.size(); i++ ){
            ...
            matrix_stack.push(cur_VM * T);// (HW3 hint: you should do something here)
        }
...
void Scene::draw(DepthShader *depthShader) {
    ...
    while( ! dfs_stack.empty() ){
        ...
        for ( unsigned int i = 0; i < cur -> models.size(); i++ ){
            ...
            depthShader -> modelview = cur_VM * M; // HW3: Without updating cur_VM, modelview would just be camera's view matrix.
